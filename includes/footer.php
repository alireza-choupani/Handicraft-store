...
<footer class="divTable">
  ...
  <section class="divTableRow">
    <article class="divTableCell" id="footer"><a href="http://al1almasi.ir" target="_blank" rel="noopener noreferrer">توسعه داده شده توسط علیرضا چوپانی و محمد امین جوادی</a> &copy;</span></article>
  </section>
</footer>
</div>
</div>
